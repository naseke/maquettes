...
def main():
    ...
    def dem_print_p(p: multiprocessing.Pool):
        for _ in range(1):
            p.apply_async(clients.clientTestPrint_use, ["ipc://frontend.ipc", False])
    ...
    def dem_afficher_p(p: multiprocessing.Pool):
        for _ in range(1):
            p.apply_async(clients.clientTestAfficher_use, ["ipc://frontend.ipc", False])
